...
export function AppCommandMenu({ open, onClose }: AppCommandMenuProps) {
  ...
  return (
    ...
    >
      <div
        className='aurum-scrollbar max-h-[calc(100dvh-32px)] w-full max-w-[560px] overflow-y-auto rounded-[30px] border border-[var(--aurum-border)] bg-white p-4 shadow-[0_28px_60px_-28px_rgba(17,24,39,0.55)] sm:p-5'
        ...
        <div className='mb-4 flex items-start justify-between gap-4'>
          <div className='space-y-1'>
            ...
            <p className='text-sm text-[var(--aurum-text-muted)]'>
              Start the most common Aurum workflows from anywhere in the product.
            </p>
          </div>
