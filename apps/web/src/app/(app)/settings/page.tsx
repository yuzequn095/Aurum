...
export default function SettingsPage() {
  ...
  return (
    <PageContainer className='space-y-6 pb-8 md:pb-10'>
      <section className='relative overflow-hidden rounded-[28px] border border-[var(--aurum-border)] bg-[rgba(255,255,255,0.9)] p-5 shadow-[var(--aurum-shadow)] sm:p-6 lg:p-7'>
